...
public class AtmInterface {
    ...
    static HashMap<Integer,Integer> pincard = new HashMap<>();
    static HashMap<Integer,String> nameCard = new HashMap<>();
    static HashMap<Integer,Integer> balcard = new HashMap<>();
    static List<Integer> pins = new ArrayList<>();
    static List<String> names = new ArrayList<>();
    static List<Integer> cardNumbers = new ArrayList<>();
    static List<Integer> balance = new ArrayList<>();
    static String name;
    static int choice;
    ...
    static void userCreation(String name) {
        ...
        int pin =pinCreation(name);
        int cardNumber=cardNumberCreation(pin);
